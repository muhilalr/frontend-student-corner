import logoBps from "../../../assets/logo-bps.jpg";
...
const FooterSection = () => {
  return (
    // <!-- Footer -->
    <footer class="relative bg-utama pt-16 pb-2">
      {/* <!-- Curve top shape --> */}
              ...
              <div class="flex flex-col md:flex-row gap-10">
                ...
                <div>
                  ...
                  <ul class="space-y-2">
                    ...
                    <li>
                      <a
                        href="https://spse.inaproc.id/bps"
                        class="text-base text-gray-300 hover:text-white"
                      >
